...
export default function SectionHeader({
  ...
  // ==========================================
  // LAYOUT A: DESKTOP RENDERING (Width >= 1024px)
  // ==========================================
  if (isLargeDesktop) {
    return (
      <div 
        ref={ref}
        className="px-[10px] md:px-[22px] py-16 flex flex-col md:flex-row justify-between items-end gap-6 w-full select-none"
      ...
      >
        ...
        <div 
          className="max-w-sm text-[10px] font-mono capitalize leading-relaxed text-start p-0 m-0 text-[var(--muted-foreground)]"
          style={{ 
  ...
  return (
    <MobileSectionText
      ...
      getFillMaskStyle={getFillMaskStyle}
    />
  );
}